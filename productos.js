...
function abrirModalEdicion(codigo, fechaVenc) {
    ...
    // Crear la caja blanca del formulario (le agregamos overflow-y por si la pantalla es pequeña)
    const modalBox = document.createElement("div");
...
            const fechaAEliminar = prod.fechaVencimiento || ''; // Manejamos el caso sin fecha
            
...
                
                // Conservamos el producto si tiene un ID distinto, O si tiene el mismo ID pero diferente fecha
