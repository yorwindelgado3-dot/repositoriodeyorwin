...
function cerrarSesion() {
    ...
    // 3. Limpieza de la interfaz (esto es lo que evita que el nuevo usuario vea datos anteriores)
    document.getElementById("inUsuario").value = "";
    document.getElementById("inClave").value = "";
    
    // 4. Limpieza de los campos del inventario (muy importante)
    // Si tienes tablas o listas cargadas, límpialas aquí
    document.getElementById("listaInventario").innerHTML = ""; 
    
    // 5. Cambio de vista
    window.scrollTo(0, 0);
    document.querySelector('.pantalla-principal').classList.remove('activa');
